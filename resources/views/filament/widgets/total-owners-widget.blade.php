<div>
    @if(auth()->user()->role === 'admin')
        <x-filament::card class="relative bg-white dark:bg-gray-900 shadow-xl rounded-2xl overflow-hidden p-5">
            ...
            @php
                if ($ownerTrendUp === 'baru') {
                    $textColorClass = 'text-green-500';
                } elseif ($ownerTrendUp > 0) {
                    $textColorClass = 'text-green-500';
                } elseif ($ownerTrendUp < 0) {
            ...
            <div class="flex items-start justify-between">
                <div class="space-y-1">
                    ...
                    <div class="flex items-center text-sm mt-1 {{ $textColorClass }}">
                        @if($ownerTrendUp === 'baru')
                        ...
                        @elseif($ownerTrendUp > 0)
                            <span class="inline-flex items-center text-green-500 ml-1">
                                ...
                                <span class="ml-1">+{{ $ownerTrendUp }}% bulan ini</span>
                            </span>
                        @elseif($ownerTrendUp < 0)
                        ...
                        @else
                            ...
                            <span class="ml-1">Belum ada data pemilik kos bulan ini</span>
                        @endif
                    </div>
                </div>
